...
| 14 | แท็บแผนที่: แตะหมุด | การ์ดกิจกรรมขึ้นด้านล่าง แตะการ์ดแล้วเปิดรายละเอียด | ⬜ ทดสอบบนเว็บแล้ว ยังไม่ได้ทดสอบบนมือถือ |
| 15 | เลือกรูปจากคลังที่ถ่ายระหว่างงาน | ส่งได้ หน้ารายละเอียดขึ้น "จากคลังรูป" | ⬜ |
| 16 | เลือกรูปเก่าจากคลัง | ขึ้น "รูปนี้ถ่ายก่อนเริ่มงาน" และมีปุ่มโหมดสาธิตใช้เป็นรูปทดสอบ | ⬜ |
| 17 | เปิด TalkBack/VoiceOver: ค้นหา → ลงทะเบียน → เช็กอิน | อ่านได้ครบทุกปุ่ม ขั้นตอนเช็กอินบอกว่าเสร็จแล้ว | ⬜ |
| 18 | ตั้งขนาดตัวอักษรของเครื่องใหญ่สุด | ทุกหน้ายังอ่านและกดได้ ตัวเลขไม่ล้น | ⬜ |
...
| คำสั่ง | ผล |
|---|---|
| `npm test` | ✅ ผ่าน 37/37 (รวม test วัดการ render ซ้ำ ดู [QUALITY.md](QUALITY.md)) |
